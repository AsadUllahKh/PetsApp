...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    private void savePet() {
        ...
        if(currentPetsUri == null) {
            ...
            if (newUri == null) {
                Toast.makeText(this, "Insert Pet Faild ", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(this, "Insert Pet Successfully ", Toast.LENGTH_SHORT).show();
            }
            ...
            if (rowsAffected == 0){
                ...
                Toast.makeText(this, "Update Pet successfully  " , Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void deletePet() {
        int affectedrow = getContentResolver().delete(currentPetsUri,null,null);
        if (affectedrow == 0){
